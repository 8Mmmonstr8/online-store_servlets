...
--
-- Host: localhost    Database: online_store_servlets
-- ------------------------------------------------------
-- Server version	8.0.22

CREATE DATABASE IF NOT EXISTS `online_store_servlets` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `online_store_servlets`;
